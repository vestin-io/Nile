import {
  ...
  type ConnectionIdentityResolver,
...
export class LiveSetupResolver {
  ...
  constructor(
    private readonly identityKeyResolver: ConnectionIdentityResolver = CONNECTION_RUNTIME_REGISTRY.read()
  ...
  resolveAuthProfileState(
    ...
    if (profile.providerId === "openai-codex") {
      ...
      return {
        value: this.stateFactory.buildOpenAiSessionProfileState({
