...
import { CurrentStateFactory } from "./StateFactory";
...
export class CurrentStateResolver {
  private readonly stateFactory: CurrentStateFactory;
  ...
  constructor(
    ...
    this.stateFactory = new CurrentStateFactory(this.identityKeyResolver);
  }
