...
export type AgentAdapterCapabilities = {
  detect: AgentCapabilitySupport;
  apply: AgentCapabilitySupport;
  import: AgentCapabilitySupport;
  history: AgentCapabilitySupport;
  rollback: AgentCapabilitySupport;
  desktopSupport: AgentCapabilitySupport;
};
