...
export class CurrentStateMatcher {
  constructor(
  ...
  match(resolved: ResolvedCurrentState): MatchCurrentStateResult {
  ...
  private matchConnection(resolved: ResolvedCurrentState): MatchedAgentConnection | null {
