  ...
  return (
    <div className="flex items-start justify-between gap-4">
      <div className="flex min-w-0 items-start gap-3">
        <div className={`flex h-12 w-12 items-center justify-center rounded-xl border bg-muted/40 p-2 [&_svg]:h-8 [&_svg]:w-8 ${agentToneClass(agent.agentId)}`}>
          <div
            aria-hidden="true"
            dangerouslySetInnerHTML={{ __html: renderAgentIcon(agent.agentId) }}
          />
        </div>
